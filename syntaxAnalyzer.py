...
symbolTable.define("happy", "int", "ARGUMENT")
symbolTable.define("gg", "int", "FIELD")
symbolTable.define("beep", "int", "ARGUMENT")
print("class table: ", symbolTable.classTable)
print("subroutine table: ", symbolTable.subroutineTable)
